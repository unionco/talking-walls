...
final class Debug_Mode {
	...
	public function display_notice() {
		...
		<div class="wpaas-debug-mode-notice">
			<p>
				...
				<?php esc_html_e( 'Changes in debug mode are not saved and are not visible by visitors to your site.', 'gd-system-plugin' ); ?>
			</p>
		</div>
	...
	public function display() {
		...
		<div id="wpaas-debug-mode" class="cleanslate">
			...
			<h5>
				<?php esc_html_e( 'Debugger - Safe Mode', 'gd-system-plugin' ); ?>
